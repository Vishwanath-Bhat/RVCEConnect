...
const {getProfileDetailsOfAlumni, updateAlumniProfileDetails, getSuggestedAlumnis, getAdditionalInfoOfAlumni, updateAdditionalInfo} = require('../controllers/alumniDashController')
